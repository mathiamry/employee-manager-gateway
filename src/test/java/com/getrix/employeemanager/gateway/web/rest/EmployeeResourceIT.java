...
import com.getrix.employeemanager.gateway.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    private static final Instant DEFAULT_DATE_OF_HIRING = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_OF_HIRING = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .dateOfHiring(DEFAULT_DATE_OF_HIRING)
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .dateOfHiring(UPDATED_DATE_OF_HIRING)
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getDateOfHiring()).isEqualTo(DEFAULT_DATE_OF_HIRING);
    ...
    void getAllEmployees() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].dateOfHiring")
            .value(hasItem(DEFAULT_DATE_OF_HIRING.toString()))
            .jsonPath("$.[*].salary")
    ...
    void getEmployee() {
        ...
        webTestClient
            ...
            .jsonPath("$.dateOfHiring")
            .value(is(DEFAULT_DATE_OF_HIRING.toString()))
            .jsonPath("$.salary")
    ...
    void putNewEmployee() throws Exception {
        ...
        assertThat(testEmployee.getDateOfHiring()).isEqualTo(UPDATED_DATE_OF_HIRING);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.lastName(UPDATED_LAST_NAME).dateOfHiring(UPDATED_DATE_OF_HIRING);
