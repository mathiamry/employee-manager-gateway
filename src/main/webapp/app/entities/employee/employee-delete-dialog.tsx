...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="employeeManagerGatewayApp.employee.delete.question">
        <Translate contentKey="employeeManagerGatewayApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
