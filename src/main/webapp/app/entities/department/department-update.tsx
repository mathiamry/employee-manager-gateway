  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="employeeManagerGatewayApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="employeeManagerGatewayApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('employeeManagerGatewayApp.department.name')}
                id="department-name"
                name="name"
                data-cy="name"
                type="text"
              />
              <ValidatedField
                label={translate('employeeManagerGatewayApp.department.address')}
