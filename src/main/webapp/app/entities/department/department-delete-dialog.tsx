...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="employeeManagerGatewayApp.department.delete.question">
        <Translate contentKey="employeeManagerGatewayApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
